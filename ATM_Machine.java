...
public class ATM_Machine extends UserBankAccount{
        ...
        while(!isExit){
            ...
            switch(userChoice){
                case 1 :
                    ...
                    System.out.println(ATM_Machine.withDrawing(withDrawAmount));
                    break;
                case 2:
                    System.out.println("Enter the Deposit amount");
                    float depositAmount = scan.nextFloat();
                    System.out.println(ATM_Machine.Deposit(depositAmount));
                    break;
                case 3:
                    System.out.println("Your Account Balance is : "+ATM_Machine.checkBalance());
                    break;
                case 4:
